...
OUTPUT_DIR = "/content/drive/MyDrive/NCU/Dissertation/Results/Supervised/No_PCA_run/all_features"
...
def load_data(cluster_features=None, sample_frac=1.0):
    ...
    """
    X = pd.read_pickle(os.path.join(BASE_PATH, "X_augmented_all_clusters.pkl"))
