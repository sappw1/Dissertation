...
from utils_no_pca import load_data, prepare_data, save_results
...
if __name__ == "__main__":
    all_results = []
    results_dir = f"/content/drive/MyDrive/NCU/Dissertation/Results/Supervised/No_PCA_run/all_features/{mode.upper()}"
